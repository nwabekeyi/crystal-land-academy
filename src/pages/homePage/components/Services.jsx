        ...
        <div className='relative'>
          <div className='relative h-[39rem] z-1 border border-n-1/10
            ...
            <div className='relative z-1 max-w-[17rem] ml-auto'>
              <h4 className='h4 mb-4 text-white sm:text-purple'>Let's guide your kids to the future</h4>
              <p className='body-2 mb-[3rem] text-white sm:text-blue'>
                ...
                {services.map((item, index) => (
                  <li key={index} className='flex items-start py-4 border-t border-n-6'>
                    <img
                      ...
                      width={24}
                    />
                    <p className='ml-4 text-white sm:text-blue'>{item}</p>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className='relative grid z-1 gap-4 lg:grid-cols-2'>
            <div className='relative min-h-[39rem] z-1 border border-n-1/10 rounded-3xl overflow-hidden'>
              ...
              <div className='absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90'>
                <h4 className='h4 mb-4 text-white sm:text-n-1'>Top-Level Education</h4>
                <p className='body-2 mb-[3rem] text-white sm:text-n-3'>
            ...
            <div className='p-4 bg-n-7 lg:min-h-[46rem] rounded-3xl overflow-hidden'>
              <div className='py-12 px-4 xl:px-8'>
                <h4 className='h4 mb-4 text-white sm:text-n-1'>Islamic-Based Learning</h4>
                <p className='body-2 mb-[2rem] text-white sm:text-n-3'>
                  At our Islamic school, we believe in nurturing the hearts and minds of children through a balanced education rooted in the Qur’an, Sunnah, and academic excellence. We are focused on raising confident, righteous leaders who walk with purpose and live with integrity.
                </p>
                  ...
                  {servicesIcons.map((item, index) => (
                    ...
                    >
                      <div
                        className={
                          index === 2
                            ? 'flex items-center justify-center bg-n-7 h-full w-full rounded-[1rem]'
                            : ''
                        }
                      >
                        <img
